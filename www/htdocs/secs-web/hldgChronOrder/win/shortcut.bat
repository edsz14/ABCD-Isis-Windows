...
SET THIS_PATH=D:\abcd\www\htdocs\secs-web\hldgChronOrder
...
call %THIS_PATH%\win\generateForJournal.bat %KEY% %FACIC% %HLDG% %TITLE% 98 %THIS_CISIS% %THIS_PATH% %THIS_TMP_PATH% %DEBUG%  
