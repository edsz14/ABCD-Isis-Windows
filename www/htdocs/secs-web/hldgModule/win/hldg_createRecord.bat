...
if "@%APPEND_OR_CREATE_OR_COPY%" == "@append" %THIS_CISIS%\mx %SRC%  btell=0 "i=%KEY%" count=1 "proc='d*','a30{',v30,'{','a10{',v10,'{','a%TAG_RESUMIDO%{converting{'" %APPEND_OR_CREATE_OR_COPY%=%HLDG% now -all
