...
function Barcode(){	document.enviar.action="index.php";
	document.enviar.submit()}
function Generar(){
	...
	if (ixSendto!="xls" && ixSendto!="doc"){
		msgwin=window.open("","barcode","width=800,height=600,resizable,menubar,scrollbars")
		msgwin.focus()
...
echo "<font color=white>&nbsp; &nbsp; Script: barcode/barcode_menu.php";
?>
</font>
</div>
...
<form name=emitir method=post action=barcode_ex.php onsubmit="javascript:return false;">
	...
	<table cellpadding=5>
		<tr>
			<td>Valor desde</td><td><input type=text name=desde></td>
		</tr>
		<tr>
			<td>Valor hasta</td><td><input type=text name=hasta></td>
		</tr>
		<tr>
			<td>Enviar a</td>
