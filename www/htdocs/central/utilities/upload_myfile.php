...
if($fn!="")
{
echo "<br><br><form name='import' method='post' action='../dbadmin/import_doc.php'>
<input type='hidden' name=fn>
<input type='hidden' name=base>
<input type='hidden' name=cd>
Insert document text into field v99 <select name='textv99'><option value='no'>no</option><br><option value='yes'>yes</option></select><br>
</form>";
