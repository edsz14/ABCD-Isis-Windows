...
echo "<script>document.f1.in.value='AU_';</script>";
...
<?php
echo "function AbrirIndice2(Termino){var n=document.Lista.prefix.value;\n";
if (isset($arrHttp["Formato"]))
	echo "Formato='".urlencode($arrHttp["Formato"])."'\n";
else
	echo "Formato=''\n";
...
?>
	...
	<table cellpadding=0 cellspacing=0 border=0 width=100%  height=20% bgcolor=#4E617C>
		...
		<option value='TI_'>TI_</option>
		<option value='AU_'>AU_</option>
		</select>
		<a href=Javascript:Cambio()><span><strong>Change</strong></span></a>
	</table>
	</form>
