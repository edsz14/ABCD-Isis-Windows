 ...
 dhtmlXProtobarObject.prototype.a0=function(id){
...
function dhtmlXButtonPrototypeObject(){
 ...
 this.topNod.onclick=this.a1;
 this.topNod.onmouseover=this.a2;
 this.topNod.onmouseout=this.a3;
 this.topNod.onmousedown=this.a4;
 this.topNod.onmouseup=this.a5;
};
 ...
 if(this.disableImage)
{
 ...
 dhtmlXButtonPrototypeObject.prototype.a1=function(e,that){
...
{if(disabledImageSrc)this.imageTag.src=disabledImageSrc;}
 ...
 dhtmlXButtonPrototypeObject.prototype.a6=function(){if(this.topNod.className!=this.className+'Over')this.topNod.className=this.className+'Over';return true;};
 
 dhtmlXButtonPrototypeObject.prototype.a7=function(){this.topNod.className=this.className;return true;};
 
 dhtmlXButtonPrototypeObject.prototype.a4=function(){this.className=this.objectNode.className+'Down';return true;};
 
 dhtmlXButtonPrototypeObject.prototype.a5=function(){this.className=this.objectNode.className;return true;};


 
 dhtmlXButtonPrototypeObject.prototype.a3=function(e){
 if(!e)e=event;
 e.cancelBubble=true;
 if(this.timeoutop)clearTimeout(this.timeoutop);
 this.timeoutop=setTimeout(this.objectNode.a8(this.objectNode,"a7"),10);
};
 
 dhtmlXButtonPrototypeObject.prototype.a2=function(e){
 if(!e)e=event;
 e.cancelBubble=true;
 if(this.timeoutop)clearTimeout(this.timeoutop);
 this.timeoutop=setTimeout(this.objectNode.a8(this.objectNode,"a6"),10);
};
 
 dhtmlXButtonPrototypeObject.prototype.a8=function(object,functionName,time){
