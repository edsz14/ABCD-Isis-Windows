...
function Campos(Tag,i,Formato,Repetible,Url_help,Wks) {
    ...
    //alert(document.campos.SubC.value)
    document.campos.tag.value=TagCampo
//    msgwin=window.open("campos.php?wks="+Wks+"&tag="+TagCampo+"&base="+base,"Window1" ,"status=yes,resizable=yes,toolbar=false,menu=no,scrollbars=yes,,height=500,top=50,left=0")
//    msgwin=window.open("campos.php?tag="+TagCampo+"&base="+base+wks+"&is_marc="+is_marc,"Window1" ,"status=yes,resizable=yes,toolbar=false,menu=no,scrollbars=yes,,height=500,top=50,left=0")
   	msgwin=window.open("","EditC","status=yes,resizable=yes,toolbar=false,menu=no,scrollbars=yes,,height=500,top=50,left=0")
 	msgwin.focus()
