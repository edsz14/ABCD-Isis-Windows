...
function BarcodeThis(){	if (browseby=="search")
  		...
  		mfn_edit=mfn
  	msgwin=window.open("../barcode_font/barcode_1reg_ex.php?base="+base+"&print=Y&desde="+mfn+"&hasta="+mfn,"barcode","width=400,height=400,menubar=yes, scrollbars=yes, resizable=yes")
...
<frameset rows=90,45,* cols=* border=0>
<?php
if (isset($arrHttp["base"])){
