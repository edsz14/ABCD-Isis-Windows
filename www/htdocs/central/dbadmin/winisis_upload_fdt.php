...
global $arrHttp,$msgstr;
	...
	foreach ($fdt as $value){
		$f=explode('|',$value);
		$repetible="";
		if ($f[4]=="1")  $repetible="yes";
		echo "<tr><td  bgcolor=white nowrap>".$f[1]."</td><td  bgcolor=white nowrap>".$f[2]."</td><td  bgcolor=white nowrap>".$f[5]."</td><td  bgcolor=white nowrap>".$repetible."</td>";
	}
	echo "</table>";
