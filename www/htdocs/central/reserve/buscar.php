...
if (!isset($arrHttp["desde"]))$arrHttp["desde"]="reserve";

include ("../config.php");
if(isset($arrHttp["DB_PATH"])) $db_path=$arrHttp["DB_PATH"];
if (isset($def["LOGO"]) and $arrHttp["desde"]=="IAH_RESERVA")echo "<img src=".$def["LOGO"].">";
...
echo "</div></div>";
if (isset($arrHttp["desde"]) and $arrHttp["desde"]!="XIAH_RESERVA" or !isset($arrHttp["desde"]))
