<?php /* Smarty version 2.6.18, created on 2014-12-19 18:57:50
         compiled from library.list.tpl.php */ ?>
<?php if ($_SESSION['role'] == 'Administrator'): ?>
<div id="listRecords" class="listTable"></div>
<script type="text/javascript">
var lblLibFullname  = "<?php echo $this->_tpl_vars['BVS_LANG']['lblLibFullname']; ?>
";
var lblAddress  = "<?php echo $this->_tpl_vars['BVS_LANG']['lblAddress']; ?>
";
var lblCity  = "<?php echo $this->_tpl_vars['BVS_LANG']['lblCity']; ?>
";
var lblCountry  = "<?php echo $this->_tpl_vars['BVS_LANG']['lblCountry']; ?>
";
var lblInst  = "<?php echo $this->_tpl_vars['BVS_LANG']['lblInstitution']; ?>
";
var lblNote  = "<?php echo $this->_tpl_vars['BVS_LANG']['lblNote']; ?>
";
var lblEmail  = "<?php echo $this->_tpl_vars['BVS_LANG']['lblEmail']; ?>
";
var lblLibrary  = "<?php echo $this->_tpl_vars['BVS_LANG']['lblLibrary']; ?>
";
...
";
var btEdLibrary = "<?php echo $this->_tpl_vars['BVS_LANG']['btEdLibrary']; ?>
";
...
YAHOO.util.Event.addListener(window, "load", function() {
    YAHOO.example.ClientPagination = new function() {
    	...
    	this.myFormatAction = function(elCell, oRecord, oColumn, oData) {
            ...
            if (mfn != "1"){ 
                var buttonDelete = " <a href=\\"?m=library&action=delete&id="+mfn+"\\" ><img src=\\"public/images/common/icon/singleButton_delete.png\\" title=\\""+btDelete+" "+lblLibrary+"\\" alt=\\""+btDelete+ " "+lblLibrary+"\\" /></a>";
            }else{
                var buttonDelete = " ";
            }
    		var btEditLibrary = "<a href=\\"?m=library&edit=" + mfn + "&tty="+t+"&searchExpr="+search+"\\" ><img src=\\"public/images/common/icon/singleButton_edit.png\\" title=\\""+btEdLibrary+"\\" alt=\\""+btEdLibrary+"\\" /></a>";
                elCell.innerHTML = btEditLibrary + buttonDelete
		};
        var myColumnDefs = [
            {key:"MFN",label:lblID,sortable:false},			        	
    		{key:"fullname", label:lblLibFullname, sortable:false},
    		{key:"address", label:lblAddress, sortable:false},
    		{key:"city", label:lblCity, sortable:false},
    		{key:"country", label:lblCountry, sortable:false},
    		{key:"institution", label:lblInst, sortable:false},
    		{key:"note", label:lblNote, sortable:false},
    		{key:"email", label:lblEmail, sortable:false},
        ...
        this.myDataSource.responseSchema = {
            ...
            fields: [{key:"MFN",parser:YAHOO.util.DataSource.parseNumber},
                    {key:"fullname",parser:YAHOO.util.DataSource.parseString},
                    {key:"address",parser:YAHOO.util.DataSource.parseString},
                    ...
                    {key:"email",parser:YAHOO.util.DataSource.parseString},
...
"></a></span>
 ...
 <?php echo $this->_tpl_vars['BVS_LANG']['lblSearchLibrary']; ?>
</h2>
            <div class="help_message">
                <?php echo $this->_tpl_vars['BVS_LANG']['helpSearchLibrary']; ?>
