<?php /* Smarty version 2.6.18, created on 2014-12-19 18:57:39
         compiled from titleplus.list.tpl.php */ ?>
<div id="menuExport" style="display: none;">
    ...
    <!--span><a href="javascript: exportDialog('titWithoutCollection');"><?php echo $this->_tpl_vars['BVS_LANG']['btExportAllTitWithoutCollection']; ?>
</a></span><br/>
    <span><a href="javascript: exportDialog('titFormatSeCS');"><?php echo $this->_tpl_vars['BVS_LANG']['btExportAllTitFormatSeCS']; ?>
</a></span><br/>
    <span><a href="javascript: exportDialog('titFormatISSN');"><?php echo $this->_tpl_vars['BVS_LANG']['btExportAllTitFormatISSN']; ?>
</a></span><br/-->
</div>
...
<div id="collectionMenuSeCSFormat" style="display: none;">
    <span><a href="javascript: exportDialog('titWithoutCollection', 'allRegisters', 'secsFormat'); hideFullExportMenu();"><?php echo $this->_tpl_vars['BVS_LANG']['btExportAllTitWithoutCollection']; ?>
</a></span><br/>
    <span><a href="javascript: exportDialog('titFormatSeCS', 'allRegisters', 'secsFormat'); hideFullExportMenu();"><?php echo $this->_tpl_vars['BVS_LANG']['btExportAllTitFormatSeCS']; ?>
</a></span><br/>
...
<div id="collectionMenuMarcFormat" style="display: none;">
    <span><a href="javascript: exportDialog('titWithoutCollection', 'oneRegister', 'marcFormat'); hideFullExportMenu();"><?php echo $this->_tpl_vars['BVS_LANG']['btExportAllTitWithoutCollection']; ?>
</a></span><br/>
    <span><a href="javascript: exportDialog('titFormatSeCS', 'oneRegister', 'marcFormat'); hideFullExportMenu();"><?php echo $this->_tpl_vars['BVS_LANG']['btExportAllTitFormatSeCS']; ?>
</a></span><br/>
...
<div id="catalogExport" style="display: none;">
    <span><a href="javascript: exportDialog('sendToSeCS'); hideFullExportMenu();"><?php echo $this->_tpl_vars['BVS_LANG']['btSendToSeCS']; ?>
</a></span><br/>
    <span><a href="javascript: exportDialog('sendToNationalCollection'); hideFullExportMenu();"><?php echo $this->_tpl_vars['BVS_LANG']['btSendToNationalCollection']; ?>
</a></span><br/>
    <span class="exit"><a href="javascript: hideFullExportMenu();" title="Fechar"><img src="public/images/common/icon/singleButton_erase.png" alt="cancel" /></a></span>
</div>
...
";
var lblLibrary  = "<?php echo $this->_tpl_vars['BVS_LANG']['library']; ?>
";
var lblTitle  = "<?php echo $this->_tpl_vars['BVS_LANG']['title']; ?>
";
var lblCenterCode  = "<?php echo $this->_tpl_vars['BVS_LANG']['lblCenterCod']; ?>
";
var lblAcquisitionMethod = "<?php echo $this->_tpl_vars['BVS_LANG']['lblAcquisitionMethod']; ?>
";
var lblAcquisitionControl = "<?php echo $this->_tpl_vars['BVS_LANG']['lblAcquisitionControl']; ?>
";
var lblExpirationSubs = "<?php echo $this->_tpl_vars['BVS_LANG']['lblExpirationSubs']; ?>
";
var lblProvider = "<?php echo $this->_tpl_vars['BVS_LANG']['lblProvider']; ?>
";
var lblActionFacic = "<?php echo $this->_tpl_vars['BVS_LANG']['ActionFacic']; ?>
";
var lblinitialVolume = "<?php echo $this->_tpl_vars['BVS_LANG']['lblinitialVolume']; ?>
";
var lblinitialDate = "<?php echo $this->_tpl_vars['BVS_LANG']['lblinitialDate']; ?>
";
var lblinitialNumber = "<?php echo $this->_tpl_vars['BVS_LANG']['lblinitialNumber']; ?>
";
...
";
var lblTitlePlus  = "<?php echo $this->_tpl_vars['BVS_LANG']['titlePlus']; ?>
";

var btEdTitlePlus = "<?php echo $this->_tpl_vars['BVS_LANG']['btEdTitlePlus']; ?>
";
