...
<div class="middle homepage">
  ...
  <h2><fmt:message key="fine_cancellation_form"/></h2>
  ...
  <c:choose>
    ...
    <c:otherwise>
      ...
      <form method="get" action="cancel_fine_result.jsp">
        ...
        <table>
          ...
          <tr>
            ...
            <td>
              <c:choose>
                <c:when test="${config['gui.picklist.cf'] eq 'true'}">
                  <select name="obs">
                    <c:forTokens items="${config['gui.picklist.cf.items']}" delims="," var="item">
          ...
          <tr>
            <td></td>
            <td><input type="submit" name="submit" value="<fmt:message key="cancel_fine"/>"/></td>
          </tr>
        </table>
      </form>
    </c:otherwise>
