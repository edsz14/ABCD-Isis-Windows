...
EMPWEB_HOME="/opt/ABCD/www/mpweb"
...
JAVA_OPTIONS="-server -DSTART=$JETTY_START  -Djetty.home=$JETTY_HOME -Dempweb.home=$EMPWEB_HOME -Djava.util.logging.config.file=$LOGGING_CONF -Daxis.xml.reuseParsers=true -Dsun.net.client.defaultConnectTimeout=10000"
...
#####################################################
JAVA_OPTIONS="$JAVA_OPTIONS -Djetty.home=$JETTY_HOME  -Djava.library.path=$EMPWEB_HOME/common/ext"
