...
session.setAttribute("resources",absoluteContext+"/resources");
      ...
      if (_jspx_meth_fmt_message_1(_jspx_page_context))
        return;
      out.write("</title>\n");
      out.write("    <!--<style type=\"text/css\"media=\"all\">@import \"main.css\"; </style>\n");
      ...
      out.write("    \n");
      out.write("  \n");
      out.write("  <script src=lr_trim.js></script>\n");
      out.write("  <script>  \n");
      out.write("  function Enviar(){\n");
      out.write("\tlogin=Trim(document.forms[0].user.value)\n");
      out.write("\tpassword=Trim(document.forms[0].password.value)\n");
      out.write("\tif (login==\"\" || password==\"\" ){\n");
      out.write("\t\talert(\"Insert your identification data\")\n");
      out.write("\t\treturn\n");
      out.write("\t}else{\n");
      ...
      out.write("\n");
      out.write("  <body ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${not empty param.libraries ? 'onload=\"document.getElementById(\\'password\\').focus()\"' : ''}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write(">\n");
      out.write("\n");
      out.write("   ");
      org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, "institution.jspf", out, false);
      out.write("<div class=\"middle login\">\n");
      out.write("    \n");
      out.write("    <h2>");
      ...
      if (_jspx_meth_c_if_1(_jspx_page_context))
        return;
      out.write("<form method=\"post\" action=\"authenticate.jsp\">\n");
      out.write("\n");
      out.write("\n");
      out.write("\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${fn:escapeXml(param.origURL)}", java.lang.String.class, (PageContext)_jspx_page_context, _jspx_fnmap_2, false));
      out.write("\" />\n");
      out.write("\n");
      out.write("\n");
      out.write("          ");
      ...
      _jspx_th_c_if_4.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${empty param.libraries}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${fn:trim(param.user)}", java.lang.String.class, (PageContext)_jspx_page_context, _jspx_fnmap_3, false));
      out.write("\" class=\"textEntry superTextEntry\" value=\"");
      out.print( session.getAttribute("prevlogin") );
      out.write("\"/>\n");
      out.write("            \n");
      out.write("            <label>");
      if (_jspx_meth_fmt_message_7(_jspx_page_context))
        return;
      out.write(":</label>\n");
      out.write("            <input id=\"password\" type=\"password\" name=\"password\" class=\"textEntry superTextEntry\" value=\"");
 if (session.getAttribute("prevpass")!=null) {out.print(session.getAttribute("prevpass"));} 
      out.write("\"/>\n");
      out.write("            \n");
      out.write("            <div class=\"submitRow\">\n");
      out.write("\t\t\t\t\t\t<div class=\"frLeftColumn\">\n");
      out.write("\t\t\t\t\t\t<!--\t<a href=\"#\">esqueceu a senha?</a>-->\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t<div class=\"frRightColumn\">\n");
      out.write("\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t  <a href=\"javascript:Enviar()\" class=\"defaultButton goButton\">\n");
      out.write("\t\t\t\t\t\t\t\t<img src=\"defaultButton_next.png\" alt=\"\" title=\"\" />\n");
      ...
      out.write("\n");
      out.write("              \n");
      out.write("            </div>    <!-- del submitrow -->\n");
      out.write("          \n");
      out.write("    \n");
      out.write("      </div> <!-- del box content -->\n");
      out.write("      \n");
      out.write("      <div class=\"boxBottom\">\n");
      out.write("\t\t\t\t\t<div class=\"bbLeft\">&#160;</div>\n");
      out.write("\t\t\t\t\t<div class=\"bbRight\">&#160;</div>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\n");
      out.write("     \n");
      out.write("     </div> \n");
      ...
      out.write("    \n");
      out.write("    ");
      org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, "coda.jspf", out, false);
      out.write("</body>\n");
      out.write("  </html>\n");
    } catch (Throwable t) {
  ...
  private boolean _jspx_meth_fmt_message_0(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_0.setKey("institution");
  ...
  private boolean _jspx_meth_fmt_message_1(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_1.setKey("empweb_login");
  ...
  private boolean _jspx_meth_fmt_message_2(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_2.setKey("empweb_login");
  ...
  private boolean _jspx_meth_c_if_0(PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_0.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${config['gui.demo']}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
  ...
  private boolean _jspx_meth_fmt_message_3(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_0, PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_3.setKey("demo_login_message");
  ...
  private boolean _jspx_meth_c_if_1(PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_1.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${not config['gui.hide_languages']}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
  ...
  private boolean _jspx_meth_c_forEach_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_1, PageContext _jspx_page_context)
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("<a href=\"login.jsp?lang=");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${langs}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
          out.write('"');
          out.write('>');
  ...
  private boolean _jspx_meth_fmt_message_4(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_fmt_message_4.setKey((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${fn:substring(langs,0,2)}", java.lang.String.class, (PageContext)_jspx_page_context, _jspx_fnmap_1, false));
  ...
  private boolean _jspx_meth_c_if_2(PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_2.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${not empty param.libraries}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
    int _jspx_eval_c_if_2 = _jspx_th_c_if_2.doStartTag();
    if (_jspx_eval_c_if_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        if (_jspx_meth_c_if_3(_jspx_th_c_if_2, _jspx_page_context))
          return true;
        out.write("<div id=\"formRow3\" class=\"formRow formRowFocus\">\n");
        out.write("\n");
        out.write("         \n");
        out.write("                <select name=\"library\" class=\"textEntry singleTextEntry\">\n");
        out.write("                  ");
  ...
  private boolean _jspx_meth_c_if_3(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_2, PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_3.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${not empty param.errorMsg}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
  ...
  private boolean _jspx_meth_fmt_message_5(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_3, PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_5.setKey((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${fn:escapeXml(param.errorMsg)}", java.lang.String.class, (PageContext)_jspx_page_context, _jspx_fnmap_2, false));
  ...
  private boolean _jspx_meth_c_forEach_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_2, PageContext _jspx_page_context)
    ...
    _jspx_th_c_forEach_1.setItems((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${fn:split(param.libraries, ',')}", java.lang.Object.class, (PageContext)_jspx_page_context, _jspx_fnmap_0, false));
    _jspx_th_c_forEach_1.setVar("libr");
  ...
  private boolean _jspx_meth_fmt_message_6(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_6.setKey("operator_id");
  ...
  private boolean _jspx_meth_fmt_message_7(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_7.setKey("password");
  ...
  private boolean _jspx_meth_fmt_message_8(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_8.setKey("submit");
