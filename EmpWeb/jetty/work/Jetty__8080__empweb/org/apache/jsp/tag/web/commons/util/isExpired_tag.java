...
public final class isExpired_tag
  ...
  public void doTag() throws JspException, java.io.IOException {
    ...
    if( getOffset() != null ) 
      _jspx_page_context.setAttribute("offset", getOffset());
    if( getVar() != null ) 
    ...
    try {
      ...
      _jspx_page_context.setAttribute("timestamp", _jspx_sout.toString());
...
try {
    ...
    if ( (offset != null) && (offset.trim().length() >0) ) {
      ...
      cal.setTime(d);
      cal.add(GregorianCalendar.DATE, Integer.parseInt(offset+1));
      d = cal.getTime();
    }

    Date now = new Date();

    getJspContext().setAttribute("varout", (d.before(now))?"true":"false");
      ...
      if (_jspx_meth_fmt_message_0(_jspx_page_context))
        return;
      out.write(':');
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${timestamp}", java.lang.String.class, (PageContext)this.getJspContext(), null, false));
  ...
  private boolean _jspx_meth_fmt_message_0(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_0.setKey("invalid_date_or_pattern");
