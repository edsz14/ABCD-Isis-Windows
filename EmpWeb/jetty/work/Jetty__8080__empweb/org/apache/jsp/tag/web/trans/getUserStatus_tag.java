...
public final class getUserStatus_tag
...
static {
  ...
  public void doTag() throws JspException, java.io.IOException {
    ...
    if( getDatabase() != null ) 
      _jspx_page_context.setAttribute("database", getDatabase());
  ...
  private boolean _jspx_meth_io_soap_0(PageContext _jspx_page_context)
    ...
    _jspx_th_io_soap_0.setUrl((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${config['ewengine.query_service']}", java.lang.String.class, (PageContext)this.getJspContext(), null, false));
  ...
  private boolean _jspx_meth_io_body_0(javax.servlet.jsp.tagext.JspTag _jspx_th_io_soap_0, PageContext _jspx_page_context)
    ...
    if (_jspx_eval_io_body_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("        <getUserStatus xmlns=\"http://kalio.net/empweb/engine/query/v1\">\r\n");
        out.write("          <id xmlns=\"\">");
        if (_jspx_meth_util_fixUserId_0(_jspx_th_io_body_0, _jspx_page_context))
          return true;
        out.write("</id>\r\n");
        out.write("          <database xmlns=\"\">");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${fn:trim(database)}", java.lang.String.class, (PageContext)this.getJspContext(), _jspx_fnmap_0, false));
        out.write("</database>\r\n");
        out.write("        </getUserStatus>\r\n");
        out.write("      </soapenv:Body>\r\n");
  ...
  private boolean _jspx_meth_util_fixUserId_0(javax.servlet.jsp.tagext.JspTag _jspx_th_io_body_0, PageContext _jspx_page_context)
    ...
    _jspx_th_util_fixUserId_0.setJspBody(new getUserStatus_tagHelper( 0, _jspx_page_context, _jspx_th_util_fixUserId_0, null));
    _jspx_th_util_fixUserId_0.doTag();
    return false;
  }

  private class getUserStatus_tagHelper
      extends org.apache.jasper.runtime.JspFragmentHelper
  {
    ...
    public boolean invoke0( JspWriter out ) 
      throws Throwable
    {
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${fn:trim(id)}", java.lang.String.class, (PageContext)this.getJspContext(), _jspx_fnmap_0, false));
      return false;
    }
