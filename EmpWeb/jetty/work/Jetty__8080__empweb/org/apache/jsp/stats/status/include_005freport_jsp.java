package org.apache.jsp.stats.status;
...
public final class include_005freport_jsp extends org.apache.jasper.runtime.HttpJspBase
...
for (int i=0; i<tabs.length; i++) {
    if (session.getAttribute("group-"+activeweb+"-"+tabs[i]) != null ) {
      ...
      out.write("  ");
      org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, (java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("../../reports/${param.report_type}/${param.report_name}.jsp", java.lang.String.class, (PageContext)_jspx_page_context, null, false), out, false);
      out.write("</div>\n");
      out.write("\n");
